...
PSYCHOMETRIC_QUESTIONS: list[dict] = [
    {
        ...
        "options": [
            {"label": "A", "text": "Gather more data before deciding", "weights": {"analytical": 2.0}},
            ...
            {"label": "D", "text": "Ask someone with more context", "weights": {"social": 2.0}},
        ],
    ...
    },
    {
        ...
        "options": [
            {"label": "A", "text": "Researching and finding the right approach", "weights": {"analytical": 2.0}},
            ...
            {"label": "D", "text": "Keeping the team aligned and unblocked", "weights": {"social": 2.0}},
        ],
        "primary_dimensions": ["creative", "social"],
    },
    {
        ...
        "options": [
            {"label": "A", "text": "Decisions made without evidence", "weights": {"analytical": 2.0}},
            ...
            {"label": "D", "text": "Working in isolation without collaboration", "weights": {"social": 2.0}},
        ],
    ...
    },
    {
        ...
        "options": [
            {"label": "A", "text": "Find the bottleneck \u2014 what's actually broken?", "weights": {"analytical": 2.0}},
            {"label": "B", "text": "Rethink the approach entirely", "weights": {"creative": 2.0}},
            {"label": "C", "text": "Cut scope and prioritize ruthlessly", "weights": {"execution": 2.0}},
            {"label": "D", "text": "Rally the team and redistribute work", "weights": {"social": 1.5, "execution": 0.5}},
        ],
        "primary_dimensions": ["execution", "social"],
    },
    {
        "id": "psych_energy",
        "key": "psych_energy",
        ...
        "options": [
            {"label": "A", "text": "Cracking a problem nobody else could solve", "weights": {"analytical": 2.0, "creative": 0.5}},
            {"label": "B", "text": "Building something from zero", "weights": {"creative": 2.0, "execution": 0.5}},
            {"label": "C", "text": "Shipping something people actually use", "weights": {"execution": 2.0, "analytical": 0.5}},
            {"label": "D", "text": "Winning someone over or closing a deal", "weights": {"social": 2.0, "execution": 0.5}},
        ],
        "primary_dimensions": ["analytical", "creative", "execution", "social"],
    },
    {
        "id": "psych_learning",
        "key": "psych_learning",
        ...
        "options": [
            {"label": "A", "text": "Read the docs and understand the theory first", "weights": {"analytical": 2.0}},
            ...
            {"label": "D", "text": "Ask someone who already knows", "weights": {"social": 2.0}},
        ],
    ...
    },
    {
        ...
        "options": [
            {"label": "A", "text": "Being the go-to expert in a deep field", "weights": {"analytical": 2.0, "execution": 0.5}},
            {"label": "B", "text": "Having built or launched something original", "weights": {"creative": 2.0, "execution": 0.5}},
            {"label": "C", "text": "Running a high-performance team or operation", "weights": {"execution": 2.0, "social": 0.5}},
            {"label": "D", "text": "Leading and inspiring a large group of people", "weights": {"social": 2.0, "creative": 0.5}},
        ],
        "primary_dimensions": ["analytical", "creative", "execution", "social"],
    },
    {
        ...
        "options": [
            ...
            {"label": "B", "text": "Interesting \u2014 I'll rethink my approach", "weights": {"creative": 2.0}},
            {"label": "C", "text": "Fair \u2014 let me fix it right now", "weights": {"execution": 2.0}},
            {"label": "D", "text": "I appreciate that \u2014 let's discuss how to improve together", "weights": {"social": 2.0}},
        ],
        "primary_dimensions": ["analytical", "execution"],
    },
]
